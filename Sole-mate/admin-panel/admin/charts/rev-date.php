...
{
    $test[$count]["label"]=$row["date"];  // second label = database column name
    $test[$count]["y"]=$row["total"];  // Amount is from database too
    $count=$count + 1;
}
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		type: "column",
		yValueFormatString: "#,##0.## , rupees ",  // shown while hover
